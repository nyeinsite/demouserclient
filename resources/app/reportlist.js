...
`
    ...
    console.log("doctorname" + sessionStorage.getItem('doctortreatment'))
    UserService.getAppointTreatmented("make").then((res) => {
        ...
        res.data.forEach((obj) => {
            ...
            if (obj['report'] === 'no') {
                report_btn.setAttribute('class', 'btn btn-primary')
                report_btn.innerHTML = "Not Yet Report"
            } else {
            ...
            report_btn.onclick = (e) => Report(obj)
    ...
    function Report(e) {
        alert(e['id'])
        sessionStorage.setItem('reportid', e['id'])
        location.replace('reportform.html')
    }
